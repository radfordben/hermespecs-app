...
struct TurboMetaHomeView: View {
    ...
    var body: some View {
        NavigationView {
                ...
                ScrollView(showsIndicators: false) {
                    VStack(spacing: AppSpacing.lg) {
                        ...
                        VStack(spacing: AppSpacing.md) {
                            ...
                            FeatureCardWide(
                                title: "OpenClaw",
                                subtitle: openClawService.connectionState == .connected ? "Connected to Gateway" : "Connect to OpenClaw Gateway",
                                icon: "link.circle.fill",
                                gradient: [Color.purple.opacity(0.8), Color.indigo.opacity(0.8)]
                            ) {
                                showOpenClaw = true
                            }
            ...
            .fullScreenCover(isPresented: $showHermes) {
                HermesChatView(streamViewModel: streamViewModel)
            }
        }
        .onAppear {
